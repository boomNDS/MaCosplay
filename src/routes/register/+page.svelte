...
<div class="flex min-h-screen items-center justify-center">
	<div class="login-card rounded-lg p-8 shadow-lg">
		<h2 class="mb-6 text-center text-2xl font-bold">ลงทะเบียน</h2>
		<form on:submit={handleSubmit} class="space-y-4">
			<div>
				<label for="name" class="mb-2 block text-sm font-bold text-gray-700">ชื่อ</label>
				<input
					type="text"
					id="name"
			...
			<div>
				<label for="email" class="mb-2 block text-sm font-bold text-gray-700">อีเมล</label>
				<input
					type="email"
					id="email"
			...
			<div>
				<label for="password" class="mb-2 block text-sm font-bold text-gray-700">รหัสผ่าน</label>
				<input
					type="password"
					id="password"
			...
			<div>
				<label for="passwordConfirm" class="mb-2 block text-sm font-bold text-gray-700"
