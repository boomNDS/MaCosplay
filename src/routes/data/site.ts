export const siteData = {
	...
	siteDescription: 'Welcome to Online Store, start shopping now!'
};
...
export const categories = [
	{
		name: 'เกมส์',
		image: '/images/Example/Game_main_05.png',
		slug: 'bestsellers',
		featured: true
	},
	...
	{
		name: 'อนิเมะ',
		image: '/images/Example/Anime_alya_cos02.png',
		slug: 'menswear',
		featured: true
	},
	...
	{
		name: 'วิกผม',
		image: '/images/Example/Makima.png',
		slug: 'womenswear',
		featured: true
	},
	...
	{
		name: 'กำลังมาแรง',
		image: '/images/Example/Trending_main.png',
		slug: 'trending',
		featured: true
	}
];
...
export const offerBannerData = {
	endDate: '2025-03-10T23:59:00.000000Z',
	badge: 'LIMITED TIME OFFER',
	title: '50% Off On All Trending Collections',
	countdownHeader: 'Hurry Up! Offer Ends In',
	buttonText: 'Shop Now',
...
export const footerData = [
	{
		title: 'Collections',
		links: [
			{ name: "Men's Wear", href: '/collections/menswear' },
			{ name: "Women's Wear", href: '/collections/womenswear' },
			{ name: 'Trending collections', href: '/collections/trending' },
